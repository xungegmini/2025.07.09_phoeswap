  ...
  return (
    <div className="flex-1 w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <section id="hero" className="overflow-hidden pt-16 pb-24 lg:pt-24 lg:pb-40">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="flex flex-col gap-6 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mt-4">
                <Link href="/v2/swap" className="btn-primary-phoenix text-base px-8 py-3">Start Trading <ArrowRightIcon className="ml-2 h-5 w-5" /></Link>
                <Link href="#features" className="btn-secondary-phoenix text-base px-8 py-3">Learn More <ChevronDownIcon className="ml-2 h-5 w-5" /></Link>
              </div>
            </div>
        ...
        <section id="features" className="py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">{features.map(feature => <FeatureCard key={feature.title} {...feature} />)}</div>
        </section>
        ...
        <section id="how-it-works" className="py-16 md:py-24">
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12 justify-items-center items-start">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="relative p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex-shrink-0 mt-4 md:mt-0">
                <Link href="/v2/swap" className="btn-primary-phoenix bg-black text-white hover:bg-gray-800 text-base px-8 py-3">Launch App <ArrowRightIcon className="ml-2 h-5 w-5" /></Link>
              </div>
            </div>
          </div>
        </section>
